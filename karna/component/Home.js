...
<TouchableOpacity>
    ...
    <View style={{flexDirection: "row"}}>
      ...
      <View>
      <Text style={{textAlign: "center", fontSize: 20, fontWeight: "bold",textAlign:"left",marginLeft:5 }}>Setting & Privacy</Text>
      </View>
  ...
  <View style={styles.details}>
    <View style={{flexDirection: "row"}}>
      ...
      <View>
      <Text style={{textAlign: "center", fontSize: 20, fontWeight: "bold",textAlign:"left",marginLeft:5 }}>Multiple Language</Text>
      <Text style={{textAlign: "center", fontSize: 15, fontWeight: "bold",marginLeft:5}}></Text>
      </View>
