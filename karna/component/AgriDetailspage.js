...
const ListItem = ({ weight }) => (
  ...
  <View style={styles.order}>
    <View style={{flexDirection:"row",justifyContent:"space-around", alignItems:"center"}}>
      ...
      <TouchableOpacity style={{width:100,height:40,backgroundColor:"orange",borderRadius:20,alignItems:"center",justifyContent:"center"}} onPress={() => navigation.navigate("book")}>
