...
const deleteData = async () => {
  try {
    ...
    const response = await axios.put(`http://${localhost}/api/v1/updateMe`, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
  ...
  return (
    ...
    <View style={{flex:1,backgroundColor:"orange", borderBottomLeftRadius:20,borderBottomRightRadius:20 }}>
      ...
      <View style={{ alignItems: 'center',margin:10 }}>
        ...
        <View style={{flexDirection:"row", justifyContent:"space-between",}}>
          ...
          <View style={{ width: 130, height: 37, color: "black", backgroundColor: "black", borderRadius: 20, alignContent: "center",margin:5  }}>
            <Text style={{ fontSize: 18, fontWeight: "bold", color: 'white', textAlign: "center", marginTop: 10 }}>DeleteUser</Text>
          </View>
          </TouchableOpacity>
...
<View style={{flex:4,backgroundColor:"white",marginBottom:20,}}>
      ...
      <View style={{ alignItems: 'center' }}>
        <View style={styles.details}>
          ...
          <FontAwesome name="gear" size={30} color="green" />
          <Text style={{textAlign:"center",fontSize:18,fontWeight:"bold", marginLeft:10}}> Settings</Text>
          </View>
          <View>
      ...
      <View style={{ alignItems: 'center' }}>
        <View style={styles.details}>
          ...
          <Text style={{textAlign:"center",fontSize:18,fontWeight:"bold", marginLeft:10}}>Language</Text>
          </View>
          <View>
          <FontAwesome name="chevron-right" size={20} color="black" />
          </View>
